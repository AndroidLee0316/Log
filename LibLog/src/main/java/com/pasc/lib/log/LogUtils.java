...
import static com.pasc.lib.log.PascLog.assertInitialization;
...
public class LogUtils {
  ...
  public static String formatJson(String json) {
    ...
    return PascLog.sLogConfiguration.jsonFormatter.format(json);
  }
  ...
  public static String formatXml(String xml) {
    assertInitialization();
    return PascLog.sLogConfiguration.xmlFormatter.format(xml);
  }
  ...
  public static String formatThrowable(Throwable throwable) {
    assertInitialization();
    return PascLog.sLogConfiguration.throwableFormatter.format(throwable);
  }
  ...
  public static String formatThread(Thread thread) {
    assertInitialization();
    return PascLog.sLogConfiguration.threadFormatter.format(thread);
  }
  ...
  public static String formatStackTrace(StackTraceElement[] stackTrace) {
    assertInitialization();
    return PascLog.sLogConfiguration.stackTraceFormatter.format(stackTrace);
  }
  ...
  public static String addBorder(String[] segments) {
    assertInitialization();
    return PascLog.sLogConfiguration.borderFormatter.format(segments);
  }
