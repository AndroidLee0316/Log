...
public class LogConfiguration {
  ...
  public final boolean reportLog;
  ...
  public static class Builder {
    ...
    private static final String DEFAULT_TAG = "PASC-LOG";
     ...
     * @return the builder
     */
    public Builder threadInfoEnable() {
     ...
     * @return the builder
     */
    public Builder threadInfoDisable() {
     ...
     * @param baseUrl
     * @return
     * @deprecated since release version 1.0.4
     */
    ...
    public Builder setReportLog(boolean reportLog) {
      isReportLog = reportLog;
      return this;
    }
